...
<body>
	...
	<!-- Slider -->
	 <div class="slider">
		<ul>
			<li><img src="banners/banner_1.png"  width="100%" alt="Oeste Neumaticos - Neumaticos Online - Zona Oeste- Gran Buenos Aires - Todo Pago - Visa- MasterCard- 12 cuotas sin interes todos los dias"></li>
