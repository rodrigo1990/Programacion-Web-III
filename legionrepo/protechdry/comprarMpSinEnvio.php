...
$preference_data = array(
	...
	"auto_return"=>"all",
	"back_urls" => array(
		"success" => "/localhost/protechdry/landing.php",
		"failure" => "",
		"pending" => "/localhost/protechdry/landing.php"
	),
