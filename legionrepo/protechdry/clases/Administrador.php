	...
	$stmt=$baseDatos->mysqli->prepare("SELECT DISTINCT UCP.comprobante_nro,UCP.id_mp,UCP.id_tp,UCP.fecha,UCP.email_usuario,EE.descripcion as envio, EV.descripcion as venta
		...
		while($fila=$resultado->fetch_assoc()){
			...
			echo "<tr>
				...
				<td><a href='usuario-admin-comprobante.php?nro=".$fila['comprobante_nro']."' target='_blank'>".$fila['comprobante_nro']."</td>
				<td>".$fila['id_mp']."</td>
				<td>".$fila['id_tp']."</td>
				<td><a href='usuario-admin-listar-compras.php?email=".$fila['email_usuario']."'>".$fila['email_usuario']."</td>
				<td>";
			...
			echo "<td><a href='usuario-admin-actualizarEstadoEnvio.php?comprobante=".$fila['comprobante_nro']."&estado=1'>Pendiente</a><br>
						<a href='usuario-admin-actualizarEstadoEnvio.php?comprobante=".$fila['comprobante_nro']."&estado=2'>Retira en local</a><br>
