...
////////////Selector de div
	...
	var medios_pago_esta_activado=false;
	var todo_pago=false;
...
///////////Activar envios
    ...
    $("#necesita_envio").click(function() {
    	...
    	envios_esta_activado=false;
    	 ...
    	 if(medios_pago_esta_activado==true){

	            	if(mercado_pago==true){
		    		...
		    		}else if(todo_pago==true){

		    			$("#form-checkout").removeAttr("action");
			            $('#form-checkout').attr('action', 'comprarTpSinEnvio.php');
            ...
            envios_esta_activado=true;
	            ...
	            if(medios_pago_esta_activado==true){
	            	...
	            	if(mercado_pago==true){
		    			...
		    			$("#form-checkout").removeAttr("action");
			            $('#form-checkout').attr('action', 'comprarTpConEnvio.php');
...
$("input:radio[name=medio_pago]").change(function(){


	if ($("#pagar_mp").attr("checked")) {

		if(envios_esta_activado==false){
			$("#form-checkout").removeAttr("action");
            $('#form-checkout').attr('action', 'comprarMpSinEnvio.php');
            medios_pago_esta_activado=true;
	...
	$("#provincia").change(function(){
		...
		$("#departamento").keyup(function(){
			...
			if(envios_esta_activado==true){
				if(nombre_esta_validado==true&&apellido_esta_validado==true&&dni_esta_validado==true&&email_esta_validado==true&&cod_area_esta_validado==true&&telefono_esta_validado==true&&provincia_esta_validado==true&&ciudad_esta_validado==true&&cp_esta_validado==true&&calle_esta_validado==true&&altura_esta_validado==true&&piso_esta_validado==true && departamento_esta_validado==true && medios_pago_esta_activado==true){
				...
				if(nombre_esta_validado==true&&apellido_esta_validado==true&&dni_esta_validado==true&&email_esta_validado==true&&cod_area_esta_validado==true&&telefono_esta_validado==true && medios_pago_esta_activado==true){
					//$("#btn-form").css("display","block");
					$("#carrito-checkout-btn-comprar").css("pointer-events","initial");
					$("#carrito-checkout-btn-comprar").css("background-color","#15a0db");
