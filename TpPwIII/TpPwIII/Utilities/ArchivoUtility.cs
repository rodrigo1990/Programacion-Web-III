...
namespace WebApplication1.Utilities
{
    public class ArchivoUtility
    {
        ...
        /// <returns></returns>
        public static string Guardar(HttpPostedFileBase archivoSubido,int idTarea, string nombreSignificativo)
        {
            ...
            string carpetaImagenes = System.Configuration.ConfigurationManager.AppSettings["Archivos"] + "/" + idTarea.ToString();
            ...
            string nombreArchivoFinal = GenerarNombreUnico(Path.GetFileNameWithoutExtension(archivoSubido.FileName));
        ...
        private static string GenerarNombreUnico(string nombreSignificativo)
        {
            ...
            return string.Format("{0}_{1}", StringUtility.Truncar(nombreSignificativo, 25), StringUtility.Truncar(randomString, 5));
        }
